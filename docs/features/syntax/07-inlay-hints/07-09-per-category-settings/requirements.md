...
| :--- | :---: | :--- | :---: |
| **07-09-REQ-01** | [Must] | Create a `LuaInlayHintsSettings` class to store toggle states for each category. | Pending |
| **07-09-REQ-02** | [Must] | Persist settings using the IntelliJ `PersistentStateComponent` API at the Application level. | Pending |
| **07-09-REQ-03** | [Must] | Implement a settings UI integrated into the IntelliJ Inlay Hints settings page. | Pending |
| **07-09-REQ-04** | [Must] | Ensure `LuaTypeInlayHintProvider` respects the "Local Variable" and "Annotation Suppression" settings. | Pending |
| **07-09-REQ-05** | [Must] | Ensure Parameter Hints respect the "Parameter Name" setting. | Pending |
| **07-09-REQ-06** | [Must] | Ensure Return Type Hints respect the "Return Type" setting. | Pending |
| **07-09-REQ-07** | [Must] | Ensure Method Chaining Hints respect the "Method Chaining" setting. | Pending |
| **07-09-REQ-08** | [Must] | Implement a setting for the "Large File Threshold" (default: 10,000 lines). | Pending |
| **07-09-REQ-09** | [Should] | Provide "Restore Defaults" functionality in the settings UI. | Pending |
