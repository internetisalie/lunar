...
| 4 | TOOLING-02-11 | Project binds `luacheck→B`; B unregistered from inventory; global binds A (usable) | `resolveDetailed(project, "luacheck")` | `Resolved(A, GLOBAL_BINDING)`; skipped contains `(PROJECT_BINDING, "B", NOT_IN_INVENTORY)` |
