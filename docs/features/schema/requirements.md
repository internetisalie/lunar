...
| [`SCHEMA-02`](02-rockspec-provider/requirements.md) | **Rockspec Schema Provider** | **S** | **Partial** | A `JsonSchemaFileProvider` mapping `.rockspec` → the bundled rockspec v3.0/v3.1 schema. Code + unit tests land; **live IDE binding fails (VNC gate) — see [risks-and-gaps](02-rockspec-provider/risks-and-gaps.md)**. **Supersedes the standalone [ROCKS-13](../rocks/13-rockspec-editor-support/requirements.md) design.** |
