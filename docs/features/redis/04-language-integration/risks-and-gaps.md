...
| REDIS-00-DR-02c (was DR-03) | Vendoring script: reduce Valkey `src/commands/*.json` → §4.1 schema, filtered per version; commit the generated `commandspec/*.json` + the script | design §4.1 | todo |
