...
Whether the corpus baselines move is worth measuring — they should not, since smart-mode behaviour is
unchanged, but "should not" is what §4.9 said about three other things.
