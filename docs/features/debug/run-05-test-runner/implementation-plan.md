...
- [x] Unit test for `LuaCovReportParser.toProjectData` line-number/slot consistency (`LuaCoverageTest.testToProjectDataLineNumbersAreOneBasedAndConsistent`) — regression guard for RUN-05-13 gutter-overlay defect
...
- [x] Unit tests for assertion diff parsing — covers RUN-05-10
