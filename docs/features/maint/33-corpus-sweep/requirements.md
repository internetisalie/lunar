...
| MAINT-33-08 | **Corpus Expansion** | S | Add ZeroBrane Studio with its own baseline. (KOReader admitted, measured and parked 2026-08-03 — it fits on disk at 12 MB, but sweeps in 10.2 min, pushing the corpus to 14 m 39 s against the 10-minute ceiling. It found BUG-393 on that one run. See risks-and-gaps "Technical Debt & Future Work" for the measurements. **Penlight is the recommended replacement, measured 2026-08-04** — it carries all three LDoc constructs BUG-393 was found through, at 57 indexed files/~73 s against KOReader's 477/609 s. Not yet wired in: it needs a baseline recorded from a builder run.) |
