...
| [`MAINT-31`](31-dead-code-sweep/requirements.md) | **Dead-Code Sweep** | **C** | **Not Implemented** | Execute review §3: ~1,000+ zero-reference lines (4 whole files, cycle-costing no-ops, dead declarations). Schedule **first** among the remediation features — shrinks every later diff. |
