...
| :--- | :--- | :---: | :---: | :--- |
| [`MAINT-01`](01-kotlin-conversion/requirements.md) | **Kotlin Conversion** | **M** | **Planned** | Convert 4 hand-written legacy Java files (`LuaPsiUtils`, `LuaTokenType`, `LuaCatsElementType`, `LuaPluginDisposable`) to idiomatic Kotlin. The 2 token-constant interfaces are deferred to MAINT-19. |
