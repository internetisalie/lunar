...
- **Tasks**:
  - [ ] Create `src/test/kotlin/net/internetisalie/lunar/lang/psi/LuaCatsCommentResolutionTest.kt`
...
- **Tasks**:
  - [ ] Create `src/test/kotlin/net/internetisalie/lunar/lang/resolve/LuaScopeResolveTest.kt`
