...
| :--- | :--- | :---: | :--- |
| `COMP-01` | **Keyword Completion** | **M** | Suggest Lua keywords based on syntax context (e.g., `then` after `if`, `end` to close blocks). [Spec](./01-keyword-completion/requirements.md) |
...
- **Status**: **Partial** (De-risked via `COMP-DR-01`)
- **Implementation**: `LuaCompletionContributor` (basic keywords implemented)
