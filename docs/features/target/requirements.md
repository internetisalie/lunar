...
The Target Configuration feature manages the runtime environment for Lua code, allowing users to switch between different platforms (e.g., Standard Lua, Redis, Luau) and their respective versions.
...
| **Luau**     | latest | Lua 5.4 | `runtime/luau/luau-latest/` |
