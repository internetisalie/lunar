...
| [`ROCKS-16`](16-package-browser-redesign/requirements.md) | **Package Browser Redesign (Plugins idiom)** | **S** | **Full** (VNC pending) | Redesign the ROCKS-02 browser to the IDE Plugins-page idiom (tool window): Marketplace/Installed tabs, canonical `--tree` install target, honest error/empty states, rich detail pane. Absorbs BUG-363/365/366/367/368. Delivered 2026-07-17; live UI confirmation deferred to a supervised verify-in-ide pass. |
