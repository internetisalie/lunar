...
| REFACT-09 | Colon-method rename — `function Obj:m()` and its call sites | todo | S | **NAV-13** *(done, `1afdfdca`)*; TYPE-13 *(done, `0bccadae`)*; REFACT-01 *(carved out of `-08`)* | closes `REFACT-01-08` | Serial: rename machinery |
