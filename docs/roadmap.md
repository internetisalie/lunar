...
| BUG-431 | A namespace constant completes as the qualified `wx.wxID_ANY` — **the full suite is red on main** | todo | S | — | verified on a clean tree; check BUG-423/424/425 for a regression before deciding | ✓ |
