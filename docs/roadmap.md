...
> items land — **SYNTAX-18, MAINT-23, TYPE-10, REDIS-06**, plus **ROCKS-16** (added 2026-07-16
> under the testing-surfaced-issues clause: user-feedback browser UX consolidation) — barring
> further new issues surfaced by testing. **MAINT-21**, **TARGET-07**, and **TARGET-08** are *not* MVP-gating (MAINT-21 is
...
| ROCKS-16 | Plugins-style LuaRocks package browser redesign | planned | S | ROCKS-02/-03/-05/-12 *(done)*; TOOLING-02 *(done)* | — | ✓ mostly-new UI under `rocks/browser/` + canonical `--tree` install-target fix; absorbs user-feedback BUG-363/365/366/367/368; planned 2026-07-16 → `docs/features/rocks/16-package-browser-redesign/` (7 phases; add-to-rockspec in scope, popular-packages follow-on dropped — no public luarocks.org API) |
