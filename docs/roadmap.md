...
| MAINT-19| platform.syntax Migration (Kotlin lexer/parser) | done | C | — *(independent; absorbs MAINT-01's deferred `LuaTokenTypes`/`LuaCatsTokenTypes`)* | — | Serial: lexer/parser + `.flex`/`.bnf` regen |
