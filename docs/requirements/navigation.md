...
| `NAV-03` | **Go to Class/File/Symbol** | **S** | **Future Work** | Implement `ChooseByName` contributors for quick navigation. |
...
| `NAV-05` | **Method Override Markers** | **S** | **Future Work** | Show gutter icons for methods that override or implement a parent class/interface method. |
| `NAV-06` | **Hierarchy View** | **C** | **Future Work** | Show the inheritance hierarchy for classes and tables. |
...
| `NAV-08` | **Line Markers** | **S** | **Future Work** | Display gutter markers for special call types: recursive calls and tail calls. |
...
| `NAV-10` | **Access Detector** | **S** | **Future Work** | Detect and highlight variable access patterns (read vs. write) for semantic analysis. |
