...
| [`NAV-04`](spec/nav-04-structure-view.md) | **Structure View** | **M** | Provide a hierarchical outline of the current file's functions, classes, and variables, including anonymous functions. |
