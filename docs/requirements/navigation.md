...
| `NAV-03` | **Go to Class/File/Symbol** | **S** | **Not Implemented** | Implement `ChooseByName` contributors for quick navigation. |
...
| `NAV-05` | **Method Override Markers** | **S** | **Not Implemented** | Show gutter icons for methods that override or implement a parent class/interface method. |
...
| `NAV-08` | **Line Markers** | **S** | **Not Implemented** | Display gutter markers for special call types: recursive calls and tail calls. |
