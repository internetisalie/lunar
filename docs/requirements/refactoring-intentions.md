...
| `REFACT-02` | **Introduce Variable** | **S** | **Future Work** | Extract an expression into a local variable and replace all occurrences. |
| `REFACT-03` | **Safe Delete** | **S** | **Future Work** | Verify if a symbol is unused before allowing its deletion. |
| `REFACT-04` | **Label Refactoring** | **C** | **Full** | Support renaming and refactoring of `goto` labels and their references. |
| `REFACT-05` | **Name Validator** | **S** | **Future Work** | Validate names for idiomatic conventions and suggest corrections. |
...
| `INTENT-03` | **Name Suggestion** | **S** | **Future Work** | Suggest idiomatic names when creating new variables or functions. |
