...
class LuaTortureCorpusTest : BasePlatformTestCase() {
    ...
    private fun recordExpectedAccepts(
        repoRoot: File,
        name: String,
        judged: List<Judged>,
    ) {
