...
object LuaDocDocumentationRenderer {
    fun render(sb: StringBuilder, element: LuaDocCommentOwner, docComment : LuaDocComment) {
        sb.append("<h2>").append(element.text).append("</h2>")
...
// TODO: Inject newlines since markdown is newline-sensitive
