...
object LuaCovReportHighlight {
    ...
    val COVERED: TextAttributesKey =
        TextAttributesKey.createTextAttributesKey(
            "LUACOV_COVERED",
            TextAttributes().apply { foregroundColor = COVERED_GREEN },
        )

    @Suppress("DEPRECATION")
    val UNCOVERED: TextAttributesKey =
        TextAttributesKey.createTextAttributesKey(
            "LUACOV_UNCOVERED",
            TextAttributes().apply { foregroundColor = UNCOVERED_RED },
        )
}
