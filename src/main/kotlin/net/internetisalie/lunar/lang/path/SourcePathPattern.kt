...
data object PathConfiguration {
    ...
    fun getProjectSourcePathPatterns(project: Project): List<SourcePathPattern> {
        ...
        val rockspecPatterns =
            net.internetisalie.lunar.rocks.RockspecSourcePathProvider
                .getInstance(
                    project,
                ).derivedPatterns()
