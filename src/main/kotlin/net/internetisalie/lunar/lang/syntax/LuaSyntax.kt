 ...
 */
object LuaSyntax {
    val IdentifierTokens: TokenSet =
        TokenSet.create(
            LuaTokenTypes.IDENTIFIER,
            LuaElementTypes.IDENTIFIER,
        )

    val CommentTokens: TokenSet =
        TokenSet.create(
    ...
    val StringLiteralTokens: TokenSet =
        TokenSet.create(
            LuaElementTypes.STRING,
        )

    val KeywordTokens: TokenSet =
        TokenSet.create(
            LuaElementTypes.DO,
    ...
    val PredefinedConstantTokens: TokenSet =
        TokenSet.create(
            LuaElementTypes.NIL,
    ...
    val UnaryOperatorTokens: TokenSet =
        TokenSet.create(
    ...
    val AdditiveBinaryOperatorTokens: TokenSet =
        TokenSet.create(
            LuaElementTypes.MINUS,
            LuaElementTypes.PLUS,
        )

    val MultiplicativeBinaryOperatorTokens: TokenSet =
        TokenSet.create(
            LuaElementTypes.DIV,
    ...
    val StringBinaryOperatorTokens: TokenSet =
        TokenSet.create(
            LuaElementTypes.CONCAT,
        )

    val RelationalBinaryOperatorTokens: TokenSet =
        TokenSet.create(
            LuaElementTypes.EQ,
            LuaElementTypes.GE,
            LuaElementTypes.GT,
    ...
    val BitwiseBinaryOperatorTokens: TokenSet =
        TokenSet.create(
            LuaElementTypes.AMP,
    ...
    val ShiftBinaryOperatorTokens: TokenSet =
        TokenSet.create(
            LuaElementTypes.BSL,
            LuaElementTypes.BSR,
        )

    val LogicalBinaryOperatorTokens: TokenSet =
        TokenSet.create(
            LuaElementTypes.AND,
            LuaElementTypes.OR,
        )
    ...
    val PunctuationTokens: TokenSet =
        TokenSet.create(
