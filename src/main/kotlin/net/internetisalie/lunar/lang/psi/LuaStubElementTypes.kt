...
object LuaStubElementTypes {
    ...
    val LOCAL_VAR_DECL: IStubElementType<LuaLocalVarStub, LuaLocalVarDecl> =
        LuaLocalVarStubElementType("LOCAL_VAR_DECL")
    val FUNC_DECL: IStubElementType<LuaFuncStub, LuaFuncDecl> = LuaFuncStubElementType("FUNC_DECL")
    val LOCAL_FUNC_DECL: IStubElementType<LuaLocalFuncStub, LuaLocalFuncDecl> =
        LuaLocalFuncStubElementType("LOCAL_FUNC_DECL")
