...
object LuaDocGenerator {
    ...
    private fun buildLocalFuncTemplate(
        template: Template,
        func: LuaLocalFuncDecl,
        indent: String,
    ) {
        val params = LuaPsiImplUtil.getParameters(func.parList)
        val hasReturn = hasReturnStatement(func.block)
    ...
    private fun buildClassTemplate(
        template: Template,
    ...
    private fun buildSignatureTemplate(
        template: Template,
        params: List<String>,
        hasReturn: Boolean,
        indent: String,
    ...
    private fun inferTypeByName(name: String): String {
        ...
        return when {
            ...
            lower.contains("count") ||
                ...
                lower.contains("x") ||
                lower.contains("y") -> "number"
            lower.contains(
                "is",
            ) ||
                lower.contains("has") ||
                lower.contains("can") ||
                lower.contains("enabled") -> "boolean"
