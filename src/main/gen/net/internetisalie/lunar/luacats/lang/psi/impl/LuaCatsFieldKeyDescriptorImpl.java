...
public class LuaCatsFieldKeyDescriptorImpl extends ASTWrapperPsiElement implements LuaCatsFieldKeyDescriptor {

  public LuaCatsFieldKeyDescriptorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LuaCatsVisitor visitor) {
    visitor.visitFieldKeyDescriptor(this);
  }
