...
public class LuaCatsUnionTypeImpl extends ASTWrapperPsiElement implements LuaCatsUnionType {
  ...
  @Override
  @NotNull
  public List<LuaCatsArrayType> getArrayTypeList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, LuaCatsArrayType.class);
  }
