...
public class LuaCatsVersionNumberImpl extends ASTWrapperPsiElement implements LuaCatsVersionNumber {

  public LuaCatsVersionNumberImpl(@NotNull ASTNode node) {
    super(node);
  }
