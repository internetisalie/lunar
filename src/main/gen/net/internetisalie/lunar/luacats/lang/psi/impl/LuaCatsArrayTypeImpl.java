...
public class LuaCatsArrayTypeImpl extends ASTWrapperPsiElement implements LuaCatsArrayType {
  ...
  @Override
  @NotNull
  public LuaCatsDistinctType getDistinctType() {
    return findNotNullChildByClass(LuaCatsDistinctType.class);
  }
