...
public class LuaCatsFunctionSignatureReturnTypeImpl extends ASTWrapperPsiElement implements LuaCatsFunctionSignatureReturnType {

  public LuaCatsFunctionSignatureReturnTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LuaCatsVisitor visitor) {
    visitor.visitFunctionSignatureReturnType(this);
  }
  ...
  public LuaCatsArgSymbol getArgSymbol() {
    return findNotNullChildByClass(LuaCatsArgSymbol.class);
  }
