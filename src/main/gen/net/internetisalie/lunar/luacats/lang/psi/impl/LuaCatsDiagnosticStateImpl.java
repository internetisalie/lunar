...
public class LuaCatsDiagnosticStateImpl extends ASTWrapperPsiElement implements LuaCatsDiagnosticState {

  public LuaCatsDiagnosticStateImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LuaCatsVisitor visitor) {
    visitor.visitDiagnosticState(this);
  }
