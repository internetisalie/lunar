...
public class LuaCatsModuleTagImpl extends ASTWrapperPsiElement implements LuaCatsModuleTag {

  public LuaCatsModuleTagImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LuaCatsVisitor visitor) {
    visitor.visitModuleTag(this);
  }
  ...
  @Override
  @NotNull
  public LuaCatsArgValue getArgValue() {
