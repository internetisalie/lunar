...
public class LuaCatsTypeImpl extends ASTWrapperPsiElement implements LuaCatsType {

  public LuaCatsTypeImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public LuaCatsUnionType getUnionType() {
    return findNotNullChildByClass(LuaCatsUnionType.class);
  }
