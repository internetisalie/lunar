...
public class LuaCatsFunctionSignatureTypeImpl extends ASTWrapperPsiElement implements LuaCatsFunctionSignatureType {

  public LuaCatsFunctionSignatureTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LuaCatsVisitor visitor) {
    visitor.visitFunctionSignatureType(this);
  }
