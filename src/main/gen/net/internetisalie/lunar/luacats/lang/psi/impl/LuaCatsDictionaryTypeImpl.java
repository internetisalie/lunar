...
public class LuaCatsDictionaryTypeImpl extends ASTWrapperPsiElement implements LuaCatsDictionaryType {

  public LuaCatsDictionaryTypeImpl(@NotNull ASTNode node) {
    super(node);
  }
