...
public class LuaCatsOperatorTagImpl extends ASTWrapperPsiElement implements LuaCatsOperatorTag {

  public LuaCatsOperatorTagImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LuaCatsVisitor visitor) {
    visitor.visitOperatorTag(this);
  }
