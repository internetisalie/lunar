...
public class LuaCatsLdocParamTagImpl extends LuaCatsBaseElement implements LuaCatsLdocParamTag {

  public LuaCatsLdocParamTagImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LuaCatsVisitor visitor) {
    visitor.visitLdocParamTag(this);
  }
  ...
  public LuaCatsDescription getDescription() {
    return findNotNullChildByClass(LuaCatsDescription.class);
  }
