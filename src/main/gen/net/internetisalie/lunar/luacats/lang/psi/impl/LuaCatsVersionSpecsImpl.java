...
public class LuaCatsVersionSpecsImpl extends ASTWrapperPsiElement implements LuaCatsVersionSpecs {

  public LuaCatsVersionSpecsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LuaCatsVisitor visitor) {
    visitor.visitVersionSpecs(this);
  }
  ...
  @Override
  @NotNull
  public List<LuaCatsVersionSpec> getVersionSpecList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, LuaCatsVersionSpec.class);
  }
