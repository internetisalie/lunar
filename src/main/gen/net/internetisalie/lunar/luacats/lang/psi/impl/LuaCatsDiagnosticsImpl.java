...
public class LuaCatsDiagnosticsImpl extends ASTWrapperPsiElement implements LuaCatsDiagnostics {
  ...
  @Override
  @NotNull
  public List<LuaCatsArgName> getArgNameList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, LuaCatsArgName.class);
  }
