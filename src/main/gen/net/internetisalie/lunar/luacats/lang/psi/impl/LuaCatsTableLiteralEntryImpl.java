...
public class LuaCatsTableLiteralEntryImpl extends ASTWrapperPsiElement implements LuaCatsTableLiteralEntry {

  public LuaCatsTableLiteralEntryImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LuaCatsVisitor visitor) {
    visitor.visitTableLiteralEntry(this);
  }
