...
public class LuaCatsParameterNameImpl extends ASTWrapperPsiElement implements LuaCatsParameterName {

  public LuaCatsParameterNameImpl(@NotNull ASTNode node) {
    super(node);
  }
