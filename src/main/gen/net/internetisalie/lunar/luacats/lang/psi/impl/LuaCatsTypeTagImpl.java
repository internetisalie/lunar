...
public class LuaCatsTypeTagImpl extends ASTWrapperPsiElement implements LuaCatsTypeTag {

  public LuaCatsTypeTagImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LuaCatsVisitor visitor) {
    visitor.visitTypeTag(this);
  }
