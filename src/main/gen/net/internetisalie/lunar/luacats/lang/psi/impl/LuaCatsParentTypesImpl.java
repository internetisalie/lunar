...
public class LuaCatsParentTypesImpl extends ASTWrapperPsiElement implements LuaCatsParentTypes {

  public LuaCatsParentTypesImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LuaCatsVisitor visitor) {
    visitor.visitParentTypes(this);
  }
