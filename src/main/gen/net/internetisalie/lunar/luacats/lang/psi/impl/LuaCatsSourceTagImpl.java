...
public class LuaCatsSourceTagImpl extends ASTWrapperPsiElement implements LuaCatsSourceTag {

  public LuaCatsSourceTagImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LuaCatsVisitor visitor) {
    visitor.visitSourceTag(this);
  }
