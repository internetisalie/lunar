...
public class LuaCatsFieldTagImpl extends ASTWrapperPsiElement implements LuaCatsFieldTag {
  ...
  @Override
  @NotNull
  public LuaCatsFieldDescriptor getFieldDescriptor() {
    return findNotNullChildByClass(LuaCatsFieldDescriptor.class);
  }
