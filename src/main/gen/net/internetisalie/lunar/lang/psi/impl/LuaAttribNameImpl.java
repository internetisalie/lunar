...
public class LuaAttribNameImpl extends LuaBaseElement implements LuaAttribName {

  public LuaAttribNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LuaVisitor visitor) {
    visitor.visitAttribName(this);
  }
