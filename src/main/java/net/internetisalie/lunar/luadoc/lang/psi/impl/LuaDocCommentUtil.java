...
public abstract class LuaDocCommentUtil {
    ...
    public static LuaDocCommentOwner findDocOwner(LuaDocPsiElement docElement) {
        ...
        while (true) {
            ...
            if (LuaTokenTypes.LUADOC_COMMENT.equals(node.getElementType()) /*||
                !LuaSyntax.WHITE_SPACES_OR_COMMENTS.contains(node.getElementType())*/) {
                break;
            }
        }
...
//
//        if (!(owner instanceof LuaStatement))
