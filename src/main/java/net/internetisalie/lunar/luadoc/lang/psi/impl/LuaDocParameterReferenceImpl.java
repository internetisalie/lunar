...
import net.internetisalie.lunar.luadoc.lang.psi.LuaDocParameterReference;
...
public class LuaDocParameterReferenceImpl extends LuaDocReferenceElementImpl implements LuaDocParameterReference {
  ...
  public String toString() {
    return "LuaDocParameterReferenceImpl(" + getNode().getElementType()  + "): " + StringUtil.notNullize(getName());
  }
...
//
  ...
  public String getName() {
    var element = getReferenceNameElement();
    if (element != null) {
      return getReferenceNameElement().getText();
    }
    return "reference name unavailable";
  }
