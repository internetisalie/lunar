...
import net.internetisalie.lunar.luadoc.lang.psi.LuaDocFieldReference;
...
public class LuaDocFieldReferenceImpl extends LuaDocReferenceElementImpl implements LuaDocFieldReference {
    ...
    public String toString() {
        return "LuaDocFieldReferenceImpl(" + getNode().getElementType()  + "): " + StringUtil.notNullize(getName());
    }
