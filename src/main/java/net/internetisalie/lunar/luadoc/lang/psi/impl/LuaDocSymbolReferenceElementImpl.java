...
import net.internetisalie.lunar.luadoc.lang.psi.LuaDocSymbolReference;
...
public class LuaDocSymbolReferenceElementImpl extends LuaDocReferenceElementImpl implements LuaDocSymbolReference {
    ...
    public String toString() {
        return "LuaDocSymbolReferenceElementImpl(" + getNode().getElementType()  + "): " + StringUtil.notNullize(getName());
    }
