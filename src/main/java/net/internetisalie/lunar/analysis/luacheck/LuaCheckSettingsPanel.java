...
public class LuaCheckSettingsPanel implements SearchableConfigurable, Configurable.NoScroll {
    ...
    private void createUIComponents() {
        luaCheckReleasePageLink = new HoverHyperlinkLabel(LuaBundle.message("luacheck.download"));
        ...
        commandLineOptionsLink = new HoverHyperlinkLabel(LuaBundle.message("luacheck.command_line_options"));
